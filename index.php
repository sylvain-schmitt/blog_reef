            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="main-navigation">
                    <ul class="nav navbar-nav navbar-right">
                        <li class="dropdown">
                            <a href="index.php" class="dropdown-toggle" data-toggle="dropdown">Acceuil <span class="pe-7s-angle-down"></span></a>
                        </li>
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">Articles <span class="pe-7s-angle-down"></span></a>
                        </li>
                        ...
                        <div class="col-xs-12">
                            <div class="hover-item mb30">
                                ...
                                <div class="hover-item-caption smoothie">
                                    <h3 class="vertical-center smoothie"><a href="single-post-right-sidebar.html" class="smoothie btn btn-primary page-scroll" title="voir l'article">Voir</a></h3>
                                </div>
                            </div>
                            ...
                            <a class="btn btn-primary mt30" href="single-post-right-sidebar.html">Lire la suite</a>
                        </div>
                    </div>
                </div>
            <?php endforeach ?>
                        ...
                        <?php foreach($articles as $article):?>
                            <div class="media">
                                ...
                                <div class="media-body">
                                    <span class="media-heading"><a href="#"><?= $article['title'] ?></a></span>
